...
//        ArrayList<Movie> daftarFilm = new ArrayList<>();
//        daftarFilm.add(new Movie("WICKED", "petualangan", "Minggu 19 Nov, 17:00", "AMBA.jpg"));
//        daftarFilm.add(new Movie("ZuPa", "horror", "Sabtu 12 Mei, 21:00", "ZuPa.jpg"));
